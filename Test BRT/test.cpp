...
TEST(Test_GetKeys) {
	...
	ASSERT_EQ(keys->deQueue(), 10);
	ASSERT_EQ(keys->deQueue(), 8);
	ASSERT_EQ(keys->deQueue(), 12);
	ASSERT_EQ(keys->deQueue(), 3);
}
...
TEST(Test_GetValues) {
	...
	ASSERT_EQ(values->deQueue(), 8);
	ASSERT_EQ(values->deQueue(), 3);
	ASSERT_EQ(values->deQueue(), 7);
	ASSERT_EQ(values->deQueue(), 2);
}